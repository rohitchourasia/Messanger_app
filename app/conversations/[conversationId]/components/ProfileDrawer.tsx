...
const ProfileDrawer = ({
    ...
    return (
        <>
        <ConfirmModal isOpen= {confirmModal} onClose= {()=>{setConfirmModal(false)}}/>
                                                ...
                                                <div className="flex flex-col items-center  ">
                                                    ...
                                                    <div  className="flex gap-10 my-5 ">
                                                        <div onClick={()=>{setConfirmModal(true)}}
                                                            className="flex flex-col gap-3 cursor-pointer items-center hover:opacity-70">
                                                            <div className="w-10 h-10 rounded-full bg-neutral-100 flex justify-center items-center">
                                                                <IoTrash/>
                                                                </div>
                                                        ...
                                                        <div className=" w-full pl-5 sm:px-0 sm:pt-0">
                                                            <dl className=" space-y-3 px-4 sm:space-y-6 sm:px-6">
                                                                {
                                                                    data.isGroup &&(
                                                                        <div>
